...
namespace M10_QLCV
{
	public partial class clsCongViec_LichSu : clsDBInteractionQLCV
	{
		#region Class Member Declarations
			private SqlBoolean		m_bTonTai, m_bLapLai, m_bHienThiTrenLich;
			private SqlDateTime		m_daNgay_BatDau, m_daNgay_DenHan, m_daNgay_HoanThanh, m_daNgay_SuaCuoi, m_daNgay_Lap, m_daNgay_YeuCau;
			private SqlDecimal		m_dcPhanTramHoanThanh, m_dcThoiGian_DuKien;
			private SqlInt32		m_iID_CongViec_LichSu, m_iID_MucDoUuTien, m_iID_NguoiLap, m_iID_CongViec, m_iID_NguoiYeuCau, m_iID_NguoiSuaCuoi, m_iID_CongViec_Goc, m_iID_TrangThai, m_iID_LoaiCV;
			private SqlString		m_sDiaDiem, m_sLoaiThongBao, m_sMa_CongViec, m_sDS_ID_NhanVien, m_sTieuDe, m_sMoTa;
			private SqlInt16		m_siID_ThoiGian;
		#endregion


		public clsCongViec_LichSu()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_CongViec_LichSu_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@ID_CongViec_LichSu", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, m_iID_CongViec_LichSu));
				...
				m_iID_CongViec_LichSu = (SqlInt32)scmCmdToExecute.Parameters["@ID_CongViec_LichSu"].Value;
				return true;
			}
			catch(Exception ex)
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsCongViec_LichSu::Insert::Error occured.", ex);
			}
			finally
			{
				if(m_bMainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_CongViec_LichSu_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				scmCmdToExecute.Parameters.Add(new SqlParameter("@ID_CongViec_LichSu", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, m_iID_CongViec_LichSu));
				scmCmdToExecute.Parameters.Add(new SqlParameter("@ID_CongViec", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, m_iID_CongViec));
				scmCmdToExecute.Parameters.Add(new SqlParameter("@Ma_CongViec", SqlDbType.NVarChar, 13, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sMa_CongViec));
				scmCmdToExecute.Parameters.Add(new SqlParameter("@DS_ID_NhanVien", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sDS_ID_NhanVien));
				scmCmdToExecute.Parameters.Add(new SqlParameter("@ID_MucDoUuTien", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, m_iID_MucDoUuTien));
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsCongViec_LichSu::Update::Error occured.", ex);
			}
			finally
			{
				if(m_bMainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_CongViec_LichSu_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsCongViec_LichSu::Delete::Error occured.", ex);
			}
			finally
			{
				if(m_bMainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_CongViec_LichSu_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("CongViec_LichSu");
			...
			try
			{
				...
				{
					m_iID_CongViec_LichSu = (Int32)dtToReturn.Rows[0]["ID_CongViec_LichSu"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsCongViec_LichSu::SelectOne::Error occured.", ex);
			}
			finally
			{
				if(m_bMainConnectionIsCreatedLocal)
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_CongViec_LichSu_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("CongViec_LichSu");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsCongViec_LichSu::SelectAll::Error occured.", ex);
			}
			finally
			{
				if(m_bMainConnectionIsCreatedLocal)
		...
		public SqlInt32 ID_CongViec_LichSu
		{
			get
			{
				return m_iID_CongViec_LichSu;
			}
			set
			{
				SqlInt32 iID_CongViec_LichSuTmp = (SqlInt32)value;
				if(iID_CongViec_LichSuTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("iD_CongViec_LichSu", "iD_CongViec_LichSu can't be NULL");
				}
				m_iID_CongViec_LichSu = value;
			}
		}
