...
{
    public partial class frmTaiLieuUploadFileShow_ChiTiet : FormBase
    {
        ...
        public frmTaiLieuUploadFileShow_ChiTiet(FTP_FilesManager.FTP_PhanMem phanMem,
        ...
        private void frmTaiLieuUploadFileShow_ChiTiet_Load(object sender, EventArgs e)
        {
            Load_cmbFileType();
            txtFileName.Text = m_sFileName;
            txtGhiChu.Text = m_sGhiChu;
