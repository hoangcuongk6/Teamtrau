...
{
    public partial class frmQuanLyTienDo : FormBaseGarco10
    {
        public frmQuanLyTienDo(int m_iID_TaiKhoanDangNhap)
        {
            InitializeComponent();
        ...
        private void fg_AfterRowChange(object sender, RangeEventArgs e)
        {
            ...
            cmbTrangThai2.EditValue = dt.Rows[0]["ID_TrangThai"];
            txtPhanTramHT.EditValue = dt.Rows[0]["PhanTramHoanThanh"];
            txtKhoiLuong.EditValue = dt.Rows[0]["SoLuong_KeHoach"];
        ...
        private void SaveData(int idCongViec)
        {
            ...
            cls.ID_TrangThai = Convert.ToInt32(cmbTrangThai2.EditValue);
